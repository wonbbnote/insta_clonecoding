                ...
                <div class="post-header">
                    <div class="left-wrapper" onclick="go_profile('{{ post.user.id }}')">
                        ...
                        <div class="right-wrapper">
                            <button class="bt"><img src="/static/image/more@3x.png"></button>
                        </div>                          
                    </div>
                ...
                <div class="post-body">
                    ...
                    <div class="post-icons-wrapper">
                        <div class="left-wrapper">
                            <button class="bt"><i style="margin-left: 2%" class="far fa-heart post-icon fa-2x"></i></button>
                            <button class="bt"><i style="margin-left: 2%" class="far fa-comment post-icon-2 fa-2x"></i></button>
                            <button class="bt"><i  style="margin-left: 2%"class="far fa-paper-plane post-icon-3 fa-2x"></i></button>
